  ...
  if (isLoading) {
    return (
      <section className="flex flex-col gap-5">
        <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl p-20 flex justify-center items-center">
          <div className="w-8 h-8 border-2 border-[var(--neon-emerald)]/30 border-t-[var(--neon-emerald)] rounded-full animate-spin"></div>
        </div>
      </section>
    );
  }
        ...
        <div className="mb-8">
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl font-semibold text-[var(--text-primary)] tracking-tight">ประวัติสินทรัพย์ (Asset History)</h2>
            </div>
